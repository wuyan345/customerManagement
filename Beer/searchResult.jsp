...
<body>
	...
	<hr />
	<h3><p style="text-align:center">搜索结果</p></h3>
	...
	<table border="1" align="center">
    	...
    	<% 
    		String[] data = (String[])request.getAttribute("DBdata");
   			...
   			out.print("<td>");
   			out.print("<a href=\"/ServletLearning/CustomerEdit.do?id=" + data[0] + "\"> 编辑&nbsp; </a>");
   			out.print("<a href=\"/ServletLearning/CustomerDelete.do?id=" + data[0] + "\"> 删除 </a>");
   			out.print("</td>");
   			out.print("</tr>");
    	%>
	</table>
